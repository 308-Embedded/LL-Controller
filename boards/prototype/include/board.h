...
#define STM32_VCO2_FREQUENCY     ((STM32_HSE_FREQUENCY / 4) * 50)
...
#define GPIO_SPI1_CS2   (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTA | GPIO_PIN3) /* PA3 */

#define GPIO_ACCE0_INT  (GPIO_INPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_PORTA | GPIO_PIN0) /* PA0 */
#define GPIO_GYRO0_INT  (GPIO_INPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_PORTA | GPIO_PIN1) /* PA1 */
/* SPI4 (sensors) */
...
#define GPIO_SPI4_CS1   (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTC | GPIO_PIN2) /* PC2 */
#define GPIO_SPI4_CS2   (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTC | GPIO_PIN13) /* PC13 */
...
#define GPIO_BDSHOT_CH1  (GPIO_PORTE|GPIO_PIN9|GPIO_SPEED_100MHz) /* PE9 */
#define GPIO_BDSHOT_CH2  (GPIO_PORTE|GPIO_PIN11|GPIO_SPEED_100MHz) /* PE11 */
#define GPIO_BDSHOT_CH3  (GPIO_PORTE|GPIO_PIN13|GPIO_SPEED_100MHz) /* PE13 */
#define GPIO_BDSHOT_CH4  (GPIO_PORTE|GPIO_PIN14|GPIO_SPEED_100MHz) /* PE14 */
