...
#define STM32_BOARD_XTAL        8000000ul /* External crystal */
...
#define STM32_VCO1_FREQUENCY     ((STM32_HSE_FREQUENCY / 2) * 240)
...
#define STM32_PLLCFG_PLL2R       RCC_PLL2DIVR_R2(5)
...
#define STM32_PLL2R_FREQUENCY    (STM32_VCO2_FREQUENCY / 5)
...
/* Just set these to 48 MHz for now,
 * PLL1Q/(2*2), for default speed 12.5MB/s
 */
...
#define GPIO_LED_RED      (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_CLEAR | \
                           GPIO_PORTE | GPIO_PIN3)
#define GPIO_LED_BLUE     (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_CLEAR | \
                           GPIO_PORTE | GPIO_PIN4)
#define GPIO_LED_GREEN    (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_CLEAR | \
                           GPIO_PORTE | GPIO_PIN2)

#define BOARD_LED_RED     0
#define BOARD_LED_BLUE    1
#define BOARD_LED_GREEN   2
...
#define GPIO_UART5_RX     (GPIO_UART5_RX_2 | GPIO_SPEED_100MHz) /* PB5 */
#define GPIO_UART5_TX     (GPIO_UART5_TX_2 | GPIO_SPEED_100MHz) /* PB6 */
...
/* I2C2 (onboard barometer/compass) */
...
#define GPIO_SPI1_CS1   (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTB | GPIO_PIN12) /* PB12 */

/* SPI2 (BMI088) */

#define GPIO_SPI2_MISO (GPIO_SPI2_MISO_2 | GPIO_SPEED_50MHz) /* PC2 */
#define GPIO_SPI2_MOSI (GPIO_SPI2_MOSI_3 | GPIO_SPEED_50MHz) /* PC3 */
#define GPIO_SPI2_SCK  (GPIO_SPI2_SCK_5 | GPIO_SPEED_50MHz)  /* PD3 */
#define GPIO_SPI2_CS1  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTD | GPIO_PIN4) /* PD4 BMI088 accel */
#define GPIO_SPI2_CS2  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTD | GPIO_PIN5) /* PD5 BMI088 gyro */

#define GPIO_ACCE0_INT  (GPIO_INPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_PORTC | GPIO_PIN14) /* PC14 */
#define GPIO_GYRO0_INT  (GPIO_INPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_PORTC | GPIO_PIN15) /* PC15 */

/* SPI3 (BMI270) */

#define GPIO_SPI3_MISO (GPIO_SPI3_MISO_1 | GPIO_SPEED_50MHz) /* PB4 */
#define GPIO_SPI3_MOSI (GPIO_SPI3_MOSI_1 | GPIO_SPEED_50MHz) /* PD6 */
#define GPIO_SPI3_SCK  (GPIO_SPI3_SCK_1 | GPIO_SPEED_50MHz)  /* PB3 */
#define GPIO_SPI3_CS1  (GPIO_OUTPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_OUTPUT_SET | \
                        GPIO_PORTA | GPIO_PIN15) /* PA15 BMI270 */

#define GPIO_BMI270_INT (GPIO_INPUT | GPIO_PUSHPULL | GPIO_SPEED_50MHz | GPIO_PORTB | GPIO_PIN7) /* PB7 */

#define BOARD_BMI088_SPI_BUS 2
...
#define GPIO_TIM1_CH1OUT   (GPIO_TIM1_CH1OUT_2  | GPIO_SPEED_50MHz) /* PE9  M4 */
#define GPIO_TIM1_CH2OUT   (GPIO_TIM1_CH2OUT_2  | GPIO_SPEED_50MHz) /* PE11 M3 */
#define GPIO_TIM1_CH3OUT   (GPIO_TIM1_CH3OUT_2  | GPIO_SPEED_50MHz) /* PE13 M2 */
#define GPIO_TIM1_CH4OUT   (GPIO_TIM1_CH4OUT_2  | GPIO_SPEED_50MHz) /* PE14 M1 */
#define GPIO_TIM3_CH3OUT   (GPIO_TIM3_CH3OUT_1  | GPIO_SPEED_50MHz) /* PB0  M6 */
#define GPIO_TIM3_CH4OUT   (GPIO_TIM3_CH4OUT_1  | GPIO_SPEED_50MHz) /* PB1  M5 */
#define GPIO_TIM4_CH1OUT   (GPIO_TIM4_CH1OUT_2  | GPIO_SPEED_50MHz) /* PD12 M7 */
#define GPIO_TIM4_CH2OUT   (GPIO_TIM4_CH2OUT_2  | GPIO_SPEED_50MHz) /* PD13 M8 */
#define GPIO_TIM15_CH1OUT  (GPIO_TIM15_CH1OUT_2 | GPIO_SPEED_50MHz) /* PE5  M9 */
#define GPIO_TIM15_CH2OUT  (GPIO_TIM15_CH2OUT_2 | GPIO_SPEED_50MHz) /* PE6  M10 */

#define GPIO_BDSHOT_CH1  (GPIO_PORTE|GPIO_PIN14|GPIO_SPEED_100MHz) /* PE14 M1 */
#define GPIO_BDSHOT_CH2  (GPIO_PORTE|GPIO_PIN13|GPIO_SPEED_100MHz) /* PE13 M2 */
#define GPIO_BDSHOT_CH3  (GPIO_PORTE|GPIO_PIN11|GPIO_SPEED_100MHz) /* PE11 M3 */
#define GPIO_BDSHOT_CH4  (GPIO_PORTE|GPIO_PIN9|GPIO_SPEED_100MHz)  /* PE9  M4 */


// /* TIM2 */

// #define GPIO_TIM2_CH1OUT  (GPIO_TIM2_CH1OUT_2  | GPIO_SPEED_50MHz) /* PA15 */
// #define GPIO_TIM2_CH2OUT  (GPIO_TIM2_CH2OUT_2  | GPIO_SPEED_50MHz) /* PB3 */
...
// #define GPIO_TIM4_CH1OUT  (GPIO_TIM4_CH1OUT_1  | GPIO_SPEED_50MHz) /* PB6 */
// #define GPIO_TIM4_CH2OUT  (GPIO_TIM4_CH2OUT_1  | GPIO_SPEED_50MHz) /* PB7 */

// /* TIM5 */

// #define GPIO_TIM5_CH1OUT  (GPIO_TIM5_CH1OUT_1  | GPIO_SPEED_50MHz) /* PA0 */
// #define GPIO_TIM5_CH2OUT  (GPIO_TIM5_CH2OUT_1  | GPIO_SPEED_50MHz) /* PA1 */

// /* TIM8 */

// #define GPIO_TIM8_CH1OUT  (GPIO_TIM8_CH1OUT_1  | GPIO_SPEED_50MHz) /* PC6 */
// #define GPIO_TIM8_CH2OUT  (GPIO_TIM8_CH2OUT_1  | GPIO_SPEED_50MHz) /* PC7 */
...
#endif /* __ASSEMBLY__ */
#endif /* __CUSTOM_BOARD_CORE_V1_BORAD_H */
